...
export default function Login() {
  ...
  const handleValidation = () => {
    ...
    if (password === "") { // first install react-toastify and aslo import its css file
  ...
  return (<>
    <FormContainer>
      <form onSubmit={(event) => handleSubmit(event)}>
        ...
        <input type="text" placeholder='Enter your Username' name='username' min="3" required onChange={e => handleChange(e)} />
